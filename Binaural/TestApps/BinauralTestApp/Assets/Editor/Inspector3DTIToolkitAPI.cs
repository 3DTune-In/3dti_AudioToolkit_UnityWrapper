...
[CustomEditor(typeof(Toolkit3DTIAPI))]
public class Inspector3DTIToolkitAPI : Editor
{
    Toolkit3DTIAPI toolkit;
    ...
    /// <summary>
    /// Action for slider Reverb Attenuation
    /// </summary>
    public void SliderReverbAttenuation()
    {
        toolkit.SetMagnitudeReverbAttenuation(toolkit.magReverbAttenuation);
    }
